...
*Neil:  Conditional access is an Azure AD capability that uses a policy-based approach to handle access scenarios. You have the ability to add an extra layer of security whereby you can grant user access to cloud applications under certain conditions.
