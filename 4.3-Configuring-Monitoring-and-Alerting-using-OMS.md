...
- use [Activity Log Analytics](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-activity) to see operational activities aggregated by status, view trends of activities on your Azure resources. You can also identify outages or service health issues affecting your Azure resources.
<br />
...
[OMS Network Performance Monitor (NPM)](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-network-performance-monitor):  
  This suite provides various capabilities geared to monitor the health of your network and network connectivity to your applications. This feature also provides analysis tools to gain insight on network performance.  
  NPM is cloud-based and provides a hybrid network monitoring solution that monitors connectivity between:  
