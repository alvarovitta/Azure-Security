...
Access and sign into the Azure portal.  
Follow the instructions provided in: [Enable your Azure subscription](https://docs.microsoft.com/en-us/azure/security-center/security-center-get-started#enable-your-azure-subscription)
<br />
<br />
