...
- Consider enabling password writeback on your on-premises active directory. If users sign-in using Pass-through Authentication, they can change or reset their passwords as required by an organization's security policy. The passwords are written back (synced) to the on-premises Active Directory.
<br />
<br />
