...
- Consider enabling password writeback on your on-premises active directory. Password writeback removes the need to set up and manage a complicated on-premises, self-service password reset (SSPR) solution. Users can reset their on-premises passwords wherever they are via the cloud.
<br />
<br />
