...
Data protection in the cloud depends on the state by which your data is handled and the controls available to manage that state.  

The following describes data states: 
